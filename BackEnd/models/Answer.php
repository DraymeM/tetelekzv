...
class Answer extends Model
{
     ...
     * Returns [ ['id'=>int, 'text'=>string, 'isCorrect'=>bool], … ]
     */
    ...
    /**
     * Bulk‐insert a list of answers for a question.
     * $answers = [ ['text'=>string,'isCorrect'=>bool], … ]
    ...
    /**
     * Update exactly N answers in id‐order.
     * $answers must be same length/order as existing IDs.
     */
    public function updateBulk(int $questionId, array $answers): void
    {
        // fetch existing answer IDs
        $ids = $this->selectAll(
