  ...
  return (
    <>
      <Suspense fallback={<Spinner />}>
        ...
        <button
          className="fixed top-15 right-2 p-3 bg-blue-600 hover:cursor-pointer text-white rounded-full hover:bg-blue-700 transition-all transform hover:scale-105 z-50"
