...
export default function TetelOverview() {
  ...
  if (isChildRoute) {
    ...
    return (
      <div className="flex flex-col md:flex-row min-h-[60dvh]">
        <Suspense>
          <Sidebar links={sidebarLinks} />
        </Suspense>
        <main className="flex-1 md:ml-33  md:px-2 md:pb-0 ">
          <Outlet />
        </main>
      </div>
    );
  ...
  return (
    <Suspense>
      <PageTransition>
        <main className="relative md:max-w-7xl max-w-full mx-auto md:px-10 px-3 pb-3 text-left">
          <Link
            to="/tetelek"
